#MTA4MjI5NTcyNzYyOTI3NTIxNg.GuEksk.BBJg6S5D9orUAkaIFsqWkISyHB2O02lAKCCoIY
import os
import discord
from discord.ext import commands
import pytube
import openai 
TOKEN = 'MTA4MjI5NTcyNzYyOTI3NTIxNg.GuEksk.BBJg6S5D9orUAkaIFsqWkISyHB2O02lAKCCoIY'
openai.api_key = "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"
...
async def on_message(message):
  ...
  if message.content.startswith("!download"):
    ...
    await message.channel.send(f'video descargando como:{filename}')
